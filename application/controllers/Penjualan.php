...
class Penjualan extends MY_Controller {
	...
	public function check_category_id($category_id){
		$categories = $this->produk_model->get_by_category($category_id);
	...
	public function check_price_id($price_id){
		$price = $this->produk_model->get_by_id($price_id);
	...
	public function add_item(){
		...
		$sale_price_type1 = $this->input->post('sale_price_type1');
		$sale_price_type2 = $this->input->post('sale_price_type2');
		$sale_price_type3 = $this->input->post('sale_price_type3');
		...
		if($get_product_detail){
			$data = array(
				...
				'qty'     => $quantity,
				'price'   => $sale_price,
				'price_1'   => $sale_price_type1,
				'price_2'   => $sale_price_type2,
				'price_3'   => $sale_price_type3,
